...
router.get('/bookings/user/:userId', async (req, res) => {
    try {
        const response = await axios.get(`${BASE_URL}/bookings/user/${req.params.userId}`, {
            headers: { Authorization: req.headers.authorization }
        });
        res.json(response.data);
    } catch (error) {
...
router.patch('/bookings/:id', async (req, res) => {
    try {
        const response = await axios.patch(`${BASE_URL}/bookings/${req.params.id}`, req.body, {
            headers: { Authorization: req.headers.authorization }
        });
        res.json(response.data);
    } catch (error) {
...
router.get('/touristspots/:id', async (req, res) => {
    try {
        const response = await axios.get(`${BASE_URL}/touristspots/${req.params.id}`);
        res.json(response.data);
    } catch (error) {
...
router.patch('/touristspots/:id/add-review', async (req, res) => {
    try {
        const response = await axios.patch(`${BASE_URL}/touristspots/${req.params.id}/add-review`, req.body);
        res.json(response.data);
    } catch (error) {
